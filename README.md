...
$\text{Pref}_{\text{category}}$ — доля клипов в охвате категории,  

$\text{Focus}_{\text{author}}$ — доля клипов в охвате автора.
...
$k_{\text{difficulty}}$: Коэффициент, смягчающий бонус
...
$k_{\text{novelty}}$: Коэффициент, контролирующий "небольшое преимущество".
